...
proc create_ipi_design { offsetfile design_name } {
	...
	# Copy all address to taylor_ip_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/taylor_ip_v1_0_include.tcl"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/taylor_ip_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "taylor_ip_v1_0_hw_${i}"
