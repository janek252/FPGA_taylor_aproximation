...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_16 -L processing_system7_vip_v1_0_18 -L xil_defaultlib -L lib_pkg_v1_0_3 -L fifo_generator_v13_2_9 -L lib_fifo_v1_0_18 -L lib_srl_fifo_v1_0_3 -L lib_cdc_v1_0_2 -L axi_datamover_v5_1_32 -L axi_sg_v4_1_17 -L axi_dma_v7_1_31 -L generic_baseblocks_v2_1_1 -L axi_register_slice_v2_1_30 -L axi_data_fifo_v2_1_29 -L axi_crossbar_v2_1_31 -L proc_sys_reset_v5_0_14 -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_12 -L axi_protocol_converter_v2_1_30 -L axi_mmu_v2_1_28 -L axi_clock_converter_v2_1_29 -L blk_mem_gen_v8_4_7 -L axi_dwidth_converter_v2_1_30 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot zybo_taylor xil_defaultlib.zybo_taylor xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim zybo_taylor -key {Behavioral:sim_1:Functional:zybo_taylor} -tclbatch cmd.tcl -protoinst "protoinst_files/zybo_taylor.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb zybo_taylor.wdb xsim.dir libdpi.so)
