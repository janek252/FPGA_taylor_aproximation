...
HD_PWD='C:/Users/wikto/studia/zybo_pynq/zybo_pynq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_taylor_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zybo_taylor_wrapper.tcl
