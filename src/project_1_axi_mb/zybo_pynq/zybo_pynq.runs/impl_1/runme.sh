...
HD_PWD='C:/Users/wikto/studia/zybo_pynq/zybo_pynq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_taylor_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zybo_taylor_wrapper.tcl -notrace
